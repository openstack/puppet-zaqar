  ...
  shared_examples 'zaqar authtoken' do
    ...
    context 'with default parameters' do
      ...
      it 'configure keystone_authtoken' do
        ...
        is_expected.to contain_zaqar_config('keystone_authtoken/www_authenticate_uri').with_value('http://localhost:5000')
    ...
    context 'when overriding parameters' do
      ...
      it 'configure keystone_authtoken' do
        is_expected.to contain_zaqar_config('keystone_authtoken/www_authenticate_uri').with_value('https://10.0.0.1:9999/')
