  ...
  shared_examples 'zaqar authtoken' do
    ...
    context 'with default parameters' do
      ...
      it 'configure keystone_authtoken' do
        ...
        is_expected.to contain_zaqar_config('keystone_authtoken/service_type').with_value('<SERVICE DEFAULT>')
    ...
    context 'when overriding parameters' do
      ...
      it 'configure keystone_authtoken' do
        ...
        is_expected.to contain_zaqar_config('keystone_authtoken/service_type').with_value(params[:service_type])
